...
{
    [Entity(Name = "inspect_summary")]
    public class InspectSummaryEntity : IEntity, IAutoClear
    {
        ...
        //[Property(Name = "Pats_AOI", Type = PropertyType.字符, MaxLength = 1000)]
        //public virtual string PTNumber { get; set; }
        ...
        [Property(Name = "CodeName", Type = PropertyType.字符, MaxLength = 100)]
        ...
        [Property(Name = "APINSPModel", Type = PropertyType.字符, MaxLength = 20)]
        public virtual string APINSPModel { get; set; }
        [Property(Name = "MesStatus", Type = PropertyType.字符, MaxLength = 20)]
        public virtual string MesStatus { get; set; }

        [Property(Name = "UserName", Type = PropertyType.字符, MaxLength = 50)]
