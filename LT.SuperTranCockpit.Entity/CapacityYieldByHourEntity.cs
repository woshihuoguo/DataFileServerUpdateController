...
{
    [Entity(Name = "capacity_yield_by_hour")]
    public class CapacityYieldByHourEntity : IEntity
    {
        ...
        {
            SysId = DateTime.ToString("yyyyMMdd") + "_" + Shift + "_" + Name + "_" + StartTime.ToString("HHmm");
        }
    }
}
