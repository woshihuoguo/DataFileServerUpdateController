...
{
    [Entity(Name = "defect_static_by_region")]
    public class DefectStaticByRegionEntity : IEntity
    {
        ...
        [Property(Name = "InputCount", Type = PropertyType.长整数)]
        public virtual long InputCount { get; set; }

        public virtual void GenerateSysId()
        {
            SysId = DateTime.ToString("yyyyMMdd") + "_" + Shift + "_" + Region;
        }
    }
}
