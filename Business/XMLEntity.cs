...
{
    //string AOI_MAP_IMAGE_PATH = $"IMAGE/REF_IMAGE//{inspectSummary?.StartTime?.ToString("MM") ?? ""}//{inspectSummary?.StartTime?.ToString("dd") ?? ""}//{_recipeName}//{_eqpUnitId}" +
    //$"//{panelId}//{panelId}_{_eqpUnitId}_{_procId}";

    //string AOI_MAP_IMAGE_NAME = $"{panelId}_{_eqpUnitId}_{_procId}";
